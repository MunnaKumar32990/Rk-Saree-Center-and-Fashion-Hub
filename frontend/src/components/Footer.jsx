...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-purple-900 via-purple-800 to-violet-900 text-white mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/contact" className="text-white-400 hover:text-gray-300 transition-colors">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link to="/shipping" className="text-white-400 hover:text-gray-300 transition-colors">
                  Shipping Info
                </Link>
              </li>
              <li>
