...
const WhatsAppButton = () => {
  ...
  // Show button after 2 seconds with entrance animation
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <a
        ...
        aria-label="Chat with RK Saree Fashion Hub on WhatsApp"
        onMouseEnter={() => setShowTooltip(true)}
        onMouseLeave={() => setShowTooltip(false)}
        className="relative w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.5)] hover:shadow-[0_6px_28px_rgba(37,211,102,0.7)] transition-all duration-300 hover:scale-110 active:scale-95"
      >
        {/* Pulse ring */}
